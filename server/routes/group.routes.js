...
import { addToGroup, changeAdmin, changeDescription, changeGroupPicture, createGroupChat, removeFromGroup, renameGroup } from '../controllers/group.controller.js';
const router = express.Router();


router.post('/', authUser, createGroupChat)
