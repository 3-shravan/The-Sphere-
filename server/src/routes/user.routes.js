...
import { getProfileSchema, updateProfileSchema } from "../validations/user.schemas.js"
...
router.get("/profile/:username", authUser, validateRequest(getProfileSchema), getProfiles)
router.put(
  "/update",
  authUser,
