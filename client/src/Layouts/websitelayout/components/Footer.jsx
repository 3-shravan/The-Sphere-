...
function Footer() {
  ...
  return (
    <footer className="relative w-full h-full flex overflow-hidden">
      ...
      {/* Grain overlay */}
      <div
        className="absolute inset-0 opacity-8 pointer-events-none z-999"
        style={{
  ...
  <div className="flex flex-col items-center w-full space-y-6 
    ...
    <h2 className="text-4xl text-center uppercase font-bold text-white tracking-tight leading-tighter 
    ...
    <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold leading-8 uppercase text-white mb-6 md:mb-8 font-[Gilroy]">
