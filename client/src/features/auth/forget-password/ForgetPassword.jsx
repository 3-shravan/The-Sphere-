...
import { errorToast, ForgetPasswordFormData, validForgetEmail, validForgetPhone } from "@/utils"
...
const ForgetPassword = () => {
  ...
  const submitHandler = async (e) => {
    ...
    if (validForgetEmail(formData, byEmail)) return errorToast("Provide a valid Email address")
          ...
          >
            ...
            {stage === 0 && (
              <>
                ...
                <span className={authStyles.spanLine} onClick={() => handleMethod()}>
                  Verify via
